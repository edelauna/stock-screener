...
describe('JWT Signing and Verification', () => {
  ...
  const mockEnv = {
    ...env,
    RSA_PRIVATE_KEY: mockPrivateKey
  }
  describe('getPublicKey', () => {
    it('should import the public key correctly', async () => {
      const key = await getPublicKey(mockEnv);
  ...
  describe('signMessage', () => {
    it('should sign a message correctly', async () => {
      ...
      const result = await signMessage(message, mockEnv);
  ...
  describe('verifyMessage', () => {
    it('should verify a valid message correctly', async () => {
      ...
      const result = await verifyMessage(signedMessage, mockEnv);
